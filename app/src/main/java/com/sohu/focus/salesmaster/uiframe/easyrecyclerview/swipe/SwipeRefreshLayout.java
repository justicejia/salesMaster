...
package com.sohu.focus.salesmaster.uiframe.easyrecyclerview.swipe;
...
import com.sohu.focus.salesmaster.uiframe.easyrecyclerview.FixedRecyclerView;
    ...
    private void ensureTarget() {
        ...
        if (mTarget == null) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (child.getClass().isAssignableFrom(RecyclerView.class) || child.getClass().isAssignableFrom(FixedRecyclerView.class)) {
                    mTarget = child;
                    break;
                }
            }
