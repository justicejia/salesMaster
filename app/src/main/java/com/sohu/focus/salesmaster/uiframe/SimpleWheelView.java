 ...
 * app:maskDarkColor="#00000000"
 * app:maskLightColor="#00000000"
...
public class SimpleWheelView extends View {
    ...
    /**
     * The constant DEFAULT_MASK_DARK_COLOR.
     */
    public static final int DEFAULT_MASK_DARK_COLOR = 0xD8ffffff;
    /**
     * The constant DEFAULT_MASK_LIGHT_COLOR.
     */
    ...
    /**
     * Instantiates a new Simple wheel view.
     *
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        lineColor = attribute.getColor(R.styleable.SimpleWheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(R.styleable.SimpleWheelView_lineHeight, lineHeight);

        noEmpty = attribute.getBoolean(R.styleable.SimpleWheelView_noEmpty, true);
        isEnable = attribute.getBoolean(R.styleable.SimpleWheelView_isEnable, true);
        isCyclic = attribute.getBoolean(R.styleable.SimpleWheelView_isCyclic, true);

        maskDarkColor =
                attribute.getColor(R.styleable.SimpleWheelView_maskDarkColor, DEFAULT_MASK_DARK_COLOR);
        maskLightColor =
                attribute.getColor(R.styleable.SimpleWheelView_maskLightColor, DEFAULT_MASK_LIGHT_COLOR);
    ...
    private class GoOnHandler extends Handler {
        /**
         * Instantiates a new Go on handler.
         *
    ...
    private class ItemObject {
        ...
        public synchronized boolean couldSelected() {
            ...
            if (y + move <= itemNumber / 2 * unitHeight - unitHeight + 5
                    || y + move >= itemNumber / 2 * unitHeight + unitHeight - 5) {
                isSelect = false;
            }
            return isSelect;
        }
