...
/**
 * Created by jiayuanmin on 2018/5/30
 * description:
 */
public class SubSheetHolder extends BaseViewHolder<SheetModel.DataBean> {
    private TextView title, titleMid, titleBottom;
    private TextView subtitle, subtitleBottom;

    public SubSheetHolder(ViewGroup parent) {
        super(parent, R.layout.holder_sub_sheet);
