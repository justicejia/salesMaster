package com.sohu.focus.salesmaster.uiframe.easyrecyclerview.decoration;
...
/**
 * Created by junqingqi on 2017/10/23.
 */

public class NomalDecoration extends RecyclerView.ItemDecoration {
    ...
    public NomalDecoration(Context context) {
        this.mColorDrawable = new ColorDrawable(context.getResources().getColor(R.color.standard_line));
        this.mHeight = context.getResources().getDimensionPixelOffset(R.dimen.margin_little_x);
        this.mPaddingLeft = context.getResources().getDimensionPixelOffset(R.dimen.margin_small_xxxxx);
        this.mPaddingRight = context.getResources().getDimensionPixelOffset(R.dimen.margin_small_xxxxx);
    }

    public NomalDecoration(int color, int height) {
        this.mColorDrawable = new ColorDrawable(color);
        this.mHeight = height;
    }

    public NomalDecoration(int color, int height, int paddingLeft, int paddingRight) {
        this.mColorDrawable = new ColorDrawable(color);
        this.mHeight = height;
