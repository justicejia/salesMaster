...
import static com.sohu.focus.salesmaster.kernal.log.core.LogCore.assertInitialization;
...
public class LogUtils {
    ...
    public static String formatJson(String json) {
        ...
        return LogCore.sLogConfiguration.jsonFormatter.format(json);
    }
    ...
    public static String formatXml(String xml) {
        assertInitialization();
        return LogCore.sLogConfiguration.xmlFormatter.format(xml);
    }
    ...
    public static String formatThrowable(Throwable throwable) {
        assertInitialization();
        return LogCore.sLogConfiguration.throwableFormatter.format(throwable);
    }
    ...
    public static String formatThread(Thread thread) {
        assertInitialization();
        return LogCore.sLogConfiguration.threadFormatter.format(thread);
    }
    ...
    public static String formatStackTrace(StackTraceElement[] stackTrace) {
        assertInitialization();
        return LogCore.sLogConfiguration.stackTraceFormatter.format(stackTrace);
    }
    ...
    public static String addBorder(String[] segments) {
        assertInitialization();
        return LogCore.sLogConfiguration.borderFormatter.format(segments);
    }
