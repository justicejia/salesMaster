...
/**
 * The configuration used for logging, always attached to a {@link LogEngine}, will affect all logs
 * logged by the {@link LogEngine}.
 * <p>
...
public class LogConfiguration {
    ...
    public static final int LOG_MODE_PRINTLN = 1; //普通的log
    public static final int LOG_MODE_PRINTLN2 = 2; //使用xlog
